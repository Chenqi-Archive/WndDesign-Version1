...
protected:
	...
	bool ContentUpdated() {
		if (GetStyle().auto_resize.MayAutoResize() && _parent != nullptr) {
...
protected:
	...
	//// Mouse Capture ////
protected:
	Ref<_WndBase_Impl*> _capture_wnd; // child or nullptr
public:
	void SetCapture() override final { if (_parent != nullptr) { _parent->SetChildCapture(this); } }
	void ReleaseCapture() override final { if (_parent != nullptr) { _parent->ReleaseChildCapture(); } }
private:
...
public:
	void LoseCapture() {
		if (_capture_wnd != nullptr) { _capture_wnd->LoseCapture(); _capture_wnd = nullptr; }
...
protected:
	Ref<_WndBase_Impl*> _focus_wnd;	
public:
	void SetFocus() override final { if (_parent != nullptr) { _parent->SetChildFocus(this); } }
...
public:
	void LoseFocus() {
		if (_focus_wnd != nullptr) { _focus_wnd->LoseFocus(); _focus_wnd = nullptr; }
...
public:
	bool DispatchMessage(Msg msg, Para para) const;
...
public:
	...
	virtual bool MouseHitTest(Point point) const;
