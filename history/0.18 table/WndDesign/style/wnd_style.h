...
struct WndStyle {
	...
	public:
		...
		bool MayAutoResize() const { return _width_auto_resize || _height_auto_resize; }
		bool NotAutoResize() const { return !_width_auto_resize && !_height_auto_resize; }
		bool BothAutoResize() const { return _width_auto_resize && _height_auto_resize; }
		bool WidthAutoResizeOnly() const { return _width_auto_resize && !_height_auto_resize; }
		bool HeightAutoResizeOnly() const { return !_width_auto_resize && _height_auto_resize; }
	public:
		constexpr AutoResizeStyle& width_auto_resize() { _width_auto_resize = true; return *this; }
		constexpr AutoResizeStyle& height_auto_resize() { _height_auto_resize = true; return *this; }
