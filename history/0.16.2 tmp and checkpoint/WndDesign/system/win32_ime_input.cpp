...
void ImeInput::UpdateCaretRect(HWND window_handle, Rect caret_rect_on_desktop) {
	// Change the coordinate of the caret rect.
	Rect caret_rect = caret_rect_on_desktop;
	RECT rect; 
	GetClientRect(window_handle, &rect);
	caret_rect.point = caret_rect.point - Vector(rect.left, rect.top);
