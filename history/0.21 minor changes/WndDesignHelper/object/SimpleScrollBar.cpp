...
#pragma message("Table and Textbox should support top layer for displaying scroll bar!\
  or just use a ScrollWnd to implement base layer auto resize! And add the Table and Textbox to the ScrollWnd!")
