...
void Init(uint argc, const wchar_t* argv[]) {
	...
	//_block_manager.CreateAbstractRelation(b1, b2, Point(120, 240), child_width_auto);
	//_block_manager.CreateAbstractRelation(b1, b3, Point(201, 75), child_width_auto);
	//_block_manager.CreateAbstractRelation(b1, b4, Point(-74, 10), child_width_auto);
	//_block_manager.CreateAbstractRelation(b3, b5, child_position_auto, child_width_auto);
