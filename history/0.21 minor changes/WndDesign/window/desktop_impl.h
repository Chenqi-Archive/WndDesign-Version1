...
public:
	...
	void Finish() override {  // Destroy all child windows, and exit the message loop.
		_layers.clear();
	}
...
public:
	...
	const Rect GetVisibleRegion() const override { return region_infinite; }  // Only overrided by desktop.
