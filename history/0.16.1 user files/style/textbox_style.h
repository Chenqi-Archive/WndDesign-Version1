...
public:
	...
	// It has higher priority than SizeStyle. But the size will still be bounded between min_size and max_size.
	struct AutoResize {
	public:
	...
	public:
		void set(bool width_auto_resize, bool height_auto_resize) { 
