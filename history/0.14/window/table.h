...
struct TableStyle : WndStyle {
	...
	private:
		Color32 _color = ColorSet::Gray;
		ushort _width = 1;
	public:
		constexpr GridLineStyle& width(ushort width) { _width = width; return *this; }
		constexpr GridLineStyle& color(Color32 color) { _color = color; return *this; }
	}grid_line;
...
struct Table : virtual WndBase {
	...
	virtual bool AddChild(WndBase* wnd, TablePosition position) pure;
