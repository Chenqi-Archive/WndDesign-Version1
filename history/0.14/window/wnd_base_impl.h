...
class _WndBase_Impl : virtual public WndBase, Uncopyable {
	//////////////////////////////////////////////////////////
	////                  Initialization                  ////
	//////////////////////////////////////////////////////////
private:
...
public:
	_WndBase_Impl(Alloc WndStyle* style, Handler handler);
	~_WndBase_Impl() override;

	Ref WndBase* GetParent() override final { return _parent; }
	void SetParent(Ref _WndBase_Impl* parent) {_parent = parent;}
...
public:
	...
	virtual void LayerUpdated(const Ref Layer* layer, Rect region) const { return; }
...
public:
	...
	bool AddChild(Ref WndBase* child_wnd) override { return false; }
	// Remove the child window, but not destroy the window.
	bool RemoveChild(Ref WndBase* child_wnd) override { return false; }
...
private:
	Handler _handler;
	void SetHandler(Handler handler) override final { _handler = handler; }

public:
	virtual bool DispatchMessage(Msg msg, Para para) {
		if (_handler != nullptr) { return _handler(this, msg, para); }
		return false;
	}
...
public:
	...
	virtual void SetFocus(_WndBase_Impl* wnd);	// Only overrided by desktop.
