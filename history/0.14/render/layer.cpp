...
Layer::Layer(Ref _WndBase_Impl* parent, Rect composite_region, bool is_redirected, 
...
SingleWndLayer::SingleWndLayer(Ref _WndBase_Impl* parent, Rect composite_region, Ref _WndBase_Impl* wnd,
...
MultipleWndLayer::MultipleWndLayer(Ref _WndBase_Impl* parent) :
	Layer(parent, region_empty, true,
		  region_empty, point_zero, parent->GetStyle().background),
	_entire_region() {
}

MultipleWndLayer::MultipleWndLayer(Ref _WndBase_Impl* parent, ScrollWndStyle::RegionStyle entire_region):
...
inline void MultipleWndLayer::SetChildResourceManager(Ref TargetResourceManager* resource_manager) {
