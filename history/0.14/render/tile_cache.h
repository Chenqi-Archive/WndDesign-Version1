...
class TileCache : Uncopyable{
	...
	//////////////////////////////////////////////////////////
public:
	TileCache(Ref TargetResourceManager* resource_manager, Color32 background,
...
public:
	...
	void SetBackground(Color32 background) { _background = background; }
...
public:
	...
	Ref Target* UseTarget() const;
	void ReturnTarget(Ref Target* target) const;
