...
void callback(Handle timer, void* para) {
	auto textbox = static_cast<ITextBox*>(para);
	...
	textbox->SetText(wstring(text, n));
}
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance,
	...
	style.background.setImage(L"R:\\1.jpg", true, false);
	...
	SetTimerSync(1000, callback, textbox);
